...
// Model 2: The "Dark Rainbow" Look
// Best used with Environment preset="night"
export default function GlassLens_Model2() {
    ...
    return (
        ...
        >
            <group ref={meshRef} position={[2.2, 0, 0]} scale={1.5}>
                {/* Outer Glass Lens - High Aberration Settings */}
                <mesh>
                    ...
                    <MeshTransmissionMaterial
                        ...
                        thickness={0.5}
                        roughness={0}
                        chromaticAberration={0.15} // High aberration for rainbow rings
                        distortion={0.5}          // High distortion
                        distortionScale={0.5}
                        temporalDistortion={0}    // Disabled to prevent artifacts
                        ior={1.5}
                        color="#ffffff"
                        backside={true}
